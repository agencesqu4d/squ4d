<div <?php qode_framework_class_attribute( $holder_classes ); ?> <?php qode_framework_inline_style( $holder_styles ); ?>>
	<div class="qodef-m-items">
		<?php foreach ( $items as $item ) { ?>
			<a itemprop="url" class="qodef-m-item qodef-e" href="<?php echo esc_url( $item['item_link'] ) ?>"
			   target="<?php echo esc_attr( $link_target ); ?>">
				<span class="qodef-e-title"
				      data-title="<?php echo esc_attr( $item['item_title'] ); ?>"><?php echo esc_html( $item['item_title'] ); ?></span>
			</a>
		<?php } ?>
	</div>
