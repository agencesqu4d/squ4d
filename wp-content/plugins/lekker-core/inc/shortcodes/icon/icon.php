...
if ( ! function_exists( 'lekker_core_add_icon_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function lekker_core_add_icon_shortcode( $shortcodes ) {
		$shortcodes[] = 'LekkerCoreIconShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'lekker_core_filter_register_shortcodes', 'lekker_core_add_icon_shortcode', 8 );
}

if ( class_exists( 'LekkerCoreShortcode' ) ) {
	class LekkerCoreIconShortcode extends LekkerCoreShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( LEKKER_CORE_SHORTCODES_URL_PATH . '/icon' );
			$this->set_base( 'lekker_core_icon' );
			$this->set_name( esc_html__( 'Icon', 'lekker-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds icon element', 'lekker-core' ) );
			...
			$this->set_option( array(
				...
				'options'    => array(
					...
					'tiny'    => esc_html__( 'Tiny', 'lekker-core' ),
					'small'   => esc_html__( 'Small', 'lekker-core' ),
					'medium'  => esc_html__( 'Medium', 'lekker-core' ),
					'large'   => esc_html__( 'Large', 'lekker-core' ),
					'huge'    => esc_html__( 'Huge', 'lekker-core' ),
				)
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'custom_size',
				'title'      => esc_html__( 'Custom Size', 'lekker-core' ),
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'icon_layout',
				...
				'options'       => array(
					'normal' => esc_html__( 'Normal', 'lekker-core' ),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_radius',
				'title'      => esc_html__( 'Border Radius', 'lekker-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => 'square',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'shape_size',
				'title'      => esc_html__( 'Shape Size', 'lekker-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_width',
				'title'      => esc_html__( 'Border Width', 'lekker-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => array( 'circle', 'square' ),
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'lekker_core_icon', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return lekker_core_get_template_part( 'shortcodes/icon', 'templates/icon', '', $atts );
		}
