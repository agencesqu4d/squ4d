...
if ( ! function_exists( 'lekker_core_add_elegant_icons_to_collection' ) ) {
	function lekker_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'LekkerCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'lekker_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class LekkerCoreElegantIconsPack extends QodeFrameworkIconPack {
