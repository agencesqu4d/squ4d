...
if ( ! function_exists( 'lekker_core_add_font_awesome_to_collection' ) ) {
	function lekker_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'LekkerCoreFontAwesomePack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'lekker_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class LekkerCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return LEKKER_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
