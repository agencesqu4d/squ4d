<?php
if ( ! function_exists( 'lekker_core_add_top_area_meta_options' ) ) {
	function lekker_core_add_top_area_meta_options( $page ) {
	...
	add_action( 'lekker_core_action_after_page_header_meta_map', 'lekker_core_add_top_area_meta_options', 20 );
}