	...
	<div id="qodef-top-area">
			...
			if ( is_active_sidebar( 'qodef-top-area-left' ) ) { ?>
				<div class="qodef-widget-holder qodef-top-area-left">
					<?php lekker_core_get_header_widget_area( 'top-area-left' ); ?>
				</div>
			<?php } ?>
			...
			if ( is_active_sidebar( 'qodef-top-area-right' ) ) { ?>
				<div class="qodef-widget-holder qodef-top-area-right">
					<?php lekker_core_get_header_widget_area( 'top-area-right' ); ?>
				</div>
			<?php } ?>
		
		<?php do_action( 'lekker_core_action_after_top_area' ); ?>
	</div>
<?php } ?>