...
if ( ! function_exists( 'lekker_core_add_vertical_sliding_header_options' ) ) {
	function lekker_core_add_vertical_sliding_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_vertical_sliding_header_section',
				'title'      => esc_html__( 'Vertical Sliding Header', 'lekker-core' ),
				'dependency' => array(
					'show' => array(
		...
		$section_svg_path->add_field_element(
			array(
				...
				'title'       => esc_html__( 'Full Screen Menu Open Icon SVG Path', 'lekker-core' ),
		...
		$section_svg_path->add_field_element(
			array(
				...
				'title'       => esc_html__( 'Full Screen Menu Close Icon SVG Path', 'lekker-core' ),
	...
	add_action( 'lekker_core_action_after_header_options_map', 'lekker_core_add_vertical_sliding_header_options', 10, 2 );
}

if ( ! function_exists( 'lekker_core_add_vertical_sliding_header_logo_options' ) ) {
	function lekker_core_add_vertical_sliding_header_logo_options( $page, $header_tab ) {
		...
		if ( $header_tab ) {
			$header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo - Vertical Sliding', 'lekker-core' ),
					'description' => esc_html__( 'Choose vertical sliding area logo image', 'lekker-core' ),
					'multiple'    => 'no'
				)
			);
		}
	...
	add_action( 'lekker_core_action_after_header_logo_options_map', 'lekker_core_add_vertical_sliding_header_logo_options', 10, 2 );
}