...
if ( ! function_exists( 'lekker_core_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function lekker_core_add_p_typography_options( $page ) {
		...
		if( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'lekker-core' ),
					'description' => esc_html__( 'Set values for paragraph', 'lekker-core' )
				)
			);
	...
	add_action( 'lekker_core_action_after_typography_options_map', 'lekker_core_add_p_typography_options' );
}