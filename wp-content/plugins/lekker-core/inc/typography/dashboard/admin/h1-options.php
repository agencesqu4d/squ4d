...
if ( ! function_exists( 'lekker_core_add_h1_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function lekker_core_add_h1_typography_options( $page ) {
		...
		if ( $page ) {
			$h1_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h1',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H1 Typography', 'lekker-core' ),
					'description' => esc_html__( 'Set values for Heading 1 HTML element', 'lekker-core' )
				)
			);
	...
	add_action( 'lekker_core_action_after_typography_options_map', 'lekker_core_add_h1_typography_options' );
}