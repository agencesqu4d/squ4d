...
if ( ! function_exists( 'lekker_core_add_h5_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function lekker_core_add_h5_typography_options( $page ) {
		...
		if ( $page ) {
			$h5_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h5',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H5 Typography', 'lekker-core' ),
					'description' => esc_html__( 'Set values for Heading 5 HTML element', 'lekker-core' )
				)
			);
	...
	add_action( 'lekker_core_action_after_typography_options_map', 'lekker_core_add_h5_typography_options' );
}