...
if ( ! function_exists( 'lekker_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function lekker_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'lekker-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'lekker-core' )
				)
			);
	...
	add_action( 'lekker_core_action_after_typography_options_map', 'lekker_core_add_h4_typography_options' );
}