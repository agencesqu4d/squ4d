...
if ( ! class_exists( 'LekkerCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class LekkerCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'lekker-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'lekker_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	LekkerCoreDashboardRestAPI::get_instance();
}
