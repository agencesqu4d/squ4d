...
if ( ! function_exists( 'lekker_core_search_options' ) ) {
	function lekker_core_search_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'search',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Search', 'lekker-core' ),
				'description' => esc_html__( 'Global Search Options', 'lekker-core' )
			)
		);
		...
		if ( $page ) {
			$search_page_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Search Page', 'lekker-core' )
				)
			);
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Use this option to enable/disable page title on search page', 'lekker-core' ),
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose default sidebar layout for search page', 'lekker-core' ),
			...
			if ( ! empty( $custom_sidebars ) && count( $custom_sidebars ) > 1 ) {
				$search_page_section->add_field_element(
					array(
						...
						'description' => esc_html__( 'Choose a custom sidebar to display on search page', 'lekker-core' ),
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose grid gutter size to set space between content and sidebar for search page', 'lekker-core' ),
			...
			do_action( 'lekker_core_action_after_search_page_options_map', $search_page_section );

			$search_opener_section = $page->add_section_element(
				array(
					'name'  => 'qodef_search_opener_section',
					'title' => esc_html__( 'Search Opener', 'lekker-core' )
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Search Icon Source', 'lekker-core' ),
					'default_value' => 'icon_pack',
					'options'       => lekker_core_get_select_type_options_pool( 'icon_source', false, array( 'predefined' ) )
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Search Open Icon SVG Path', 'lekker-core' ),
					'description' => esc_html__( 'Enter your search open icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'lekker-core' )
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Search Close Icon SVG Path', 'lekker-core' ),
					'description' => esc_html__( 'Enter your search close icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'lekker-core' ),
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Size', 'lekker-core' ),
					'args'       => array(
			...
			$color_row = $search_opener_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Search Icon', 'lekker-core' ),
				)
			);
			...
			$color_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Color', 'lekker-core' ),
				)
			);
			...
			$color_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Hover Color', 'lekker-core' ),
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Search Icon Label', 'lekker-core' ),
					'default_value' => 'no',
			...
			// Hook to include additional options after module options
			do_action( 'lekker_core_action_after_search_options_map', $page );
		}
	}

	add_action( 'lekker_core_action_default_options_init', 'lekker_core_search_options', lekker_core_get_admin_options_map_position( 'search' ) );
}